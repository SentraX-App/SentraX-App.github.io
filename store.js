...
(function () {
  ...
  const PRODUCTS = [
    // ---- Home Safety & Alerts -----------------------------------------
    { id: 'smoke-detector', name: 'Home Smoke Detector', category: 'safety', price: 11300, emoji: '🚨',
    ...
    // ---- First Aid & Comfort -------------------------------------------
    { id: 'hot-cold-pack', name: 'Reusable Hot & Cold Gel Pack', category: 'firstaid', price: 7500, emoji: '🧊',
    ...
    { id: 'hot-water-bottle', name: 'Rubber Hot Water Bottle', category: 'firstaid', price: 8100, emoji: '🍶',
    ...
    { id: 'first-aid-box', name: 'Compact First Aid Box (Home & Office)', category: 'firstaid', price: 17400, emoji: '📦',
    ...
    { id: 'skipping-rope', name: 'Skipping / Jump Rope', category: 'wellness', price: 5300, emoji: '🪢',
    ...
    { id: 'gym-duffel-bag', name: 'Sports & Gym Duffel Bag', category: 'wellness', price: 15800, emoji: '🎒',
    ...
    { id: 'moisturizing-foot-lotion', name: 'Moisturizing Foot & Body Lotion', category: 'wellness', price: 7500, emoji: '🧴',
    ...
    // ---- Food & Nutrition -------------------------------------------
    { id: 'brown-rice-5kg', name: 'Premium Brown Rice (5kg)', category: 'nutrition', price: 20000, emoji: '🍚',
    ...
    { id: 'pure-honey-500ml', name: 'Pure Natural Honey (500ml)', category: 'nutrition', price: 10700, emoji: '🍯',
    ...
    { id: 'rolled-oats-1kg', name: 'Rolled Oats (1kg)', category: 'nutrition', price: 8800, emoji: '🥣',
    ...
    { id: 'fresh-ginger-500g', name: 'Fresh Ginger Root (500g)', category: 'nutrition', price: 3100, emoji: '🫚',
    ...
    { id: 'zobo-drink', name: 'Chilled Zobo (Hibiscus) Drink (1.5L)', category: 'nutrition', price: 3700, emoji: '🥤',
    ...
    { id: 'tiger-nuts-500g', name: 'Dried Tiger Nuts / Aya (500g)', category: 'nutrition', price: 4300, emoji: '🌰',
    ...
    { id: 'garlic-bulbs-250g', name: 'Fresh Garlic Bulbs (250g)', category: 'nutrition', price: 2400, emoji: '🧄',
    ...
    { id: 'cashew-nuts-500g', name: 'Roasted Cashew Nuts (500g)', category: 'nutrition', price: 8100, emoji: '🥜',
    ...
    { id: 'groundnuts-500g', name: 'Roasted Groundnuts (500g)', category: 'nutrition', price: 3100, emoji: '🥜',
    ...
    { id: 'mixed-fruit-smoothies-4pk', name: 'Mixed Fruit Smoothie Bottles (4-Pack)', category: 'nutrition', price: 7500, emoji: '🥤',
    ...
    { id: 'strawberry-smoothie', name: 'Strawberry Fruit Smoothie (500ml)', category: 'nutrition', price: 3300, emoji: '🍓',
    ...
    { id: 'ginger-lemongrass-tea', name: 'Ginger & Lemongrass Herbal Tea (20 bags)', category: 'nutrition', price: 4100, emoji: '🌿',
    ...
    { id: 'turmeric-ginger-powder', name: 'Turmeric & Ginger Powder (200g)', category: 'nutrition', price: 5900, emoji: '🌕',
    ...
    { id: 'moringa-powder-250g', name: 'Moringa Leaf Powder (250g)', category: 'nutrition', price: 6200, emoji: '🌿',
    ...
    // ---- Fresh Fruits ---------------------------------------------------
    { id: 'fruit-basket-mixed', name: 'Mixed Fruit Basket (Seasonal)', category: 'fruits', price: 16800, emoji: '🧺',
    ...
    { id: 'apples-1kg', name: 'Fresh Apples (1kg)', category: 'fruits', price: 5000, emoji: '🍎',
    ...
    { id: 'oranges-1kg', name: 'Fresh Oranges (1kg)', category: 'fruits', price: 3700, emoji: '🍊',
    ...
    { id: 'bananas-bunch', name: 'Fresh Bananas (Bunch)', category: 'fruits', price: 3100, emoji: '🍌',
    ...
    { id: 'watermelon-whole', name: 'Fresh Watermelon (Whole)', category: 'fruits', price: 6000, emoji: '🍉',
    ...
    { id: 'pawpaw-whole', name: 'Fresh Pawpaw / Papaya (Whole)', category: 'fruits', price: 3100, emoji: '🥭',
    ...
    { id: 'fresh-coconut', name: 'Fresh Coconut (Whole)', category: 'fruits', price: 3700, emoji: '🥥',
    ...
    { id: 'fresh-pineapple', name: 'Fresh Pineapple (Whole)', category: 'fruits', price: 3300, emoji: '🍍',
    ...
    { id: 'fresh-avocado', name: 'Fresh Avocado (Pack of 3)', category: 'fruits', price: 4300, emoji: '🥑',
    ...
    { id: 'rose-shea-soap', name: 'Rose & Shea Butter Soap (Bar)', category: 'personalcare', price: 3300, emoji: '🌹',
    ...
    { id: 'sleep-eye-mask', name: 'Sleep Eye Mask', category: 'personalcare', price: 3800, emoji: '😴',
    ...
    { id: 'sports-water-bottle', name: 'Everyday Sports Water Bottle', category: 'kitchen-living', price: 3500, emoji: '💧',
    ...
    { id: 'glass-storage-jars', name: 'Glass Food Storage Jars (Set)', category: 'kitchen-living', price: 8300, emoji: '🫙',
    ...
    { id: 'reusable-tote-bag', name: 'Reusable Canvas Tote Bag', category: 'kitchen-living', price: 3900, emoji: '🛍️',
    ...
    { id: 'green-tea-20bags', name: 'Green Tea (20 bags)', category: 'nutrition', price: 3800, emoji: '🍵',
    ...
    { id: 'chia-seeds-250g', name: 'Chia Seeds (250g)', category: 'nutrition', price: 5400, emoji: '🌱',
    ...
    { id: 'dried-dates-500g', name: 'Dried Dates (500g)', category: 'nutrition', price: 4700, emoji: '🌴',
    ...
    { id: 'fresh-mango', name: 'Fresh Mango (Pack of 2)', category: 'fruits', price: 3800, emoji: '🥭',
    ...
    { id: 'fresh-grapes-500g', name: 'Fresh Grapes (500g)', category: 'fruits', price: 5200, emoji: '🍇',
    ...
    { id: 'bamboo-toothbrush', name: 'Bamboo Toothbrush', category: 'personalcare', price: 1800, emoji: '🪥',
