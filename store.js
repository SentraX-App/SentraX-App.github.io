...
(function () {
  ...
  CATEGORIES.forEach(function (c) { CATEGORY_NAME[c.key] = c.name; });
    ...
    { id: 'sports-water-bottle', name: 'Everyday Sports Water Bottle', category: 'kitchen-living', price: 6500,
      image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Sports%20cap%20(bottle)%20-%20open.jpg?width=500',
    ...
    { id: 'travel-toiletry-bag', name: 'Travel Toiletry Bag', category: 'personalcare', price: 6000,
      image: 'https://images.pexels.com/photos/9185864/pexels-photo-9185864.jpeg?auto=compress&w=800',
    ...
    { id: 'kitchen-fork-set', name: 'Kitchen Fork Set', category: 'kitchen-living', price: 4000,
      image: 'https://images.pexels.com/photos/16467935/pexels-photo-16467935.jpeg?auto=compress&w=800',
