...
(function () {
  ...
  const PRODUCTS = [
    { id: 'walking-cane', name: 'Adjustable Walking Cane', category: 'mobility', price: 20900, emoji: '🦯',
    ...
    { id: 'crutches', name: 'Underarm Crutches (Pair)', category: 'mobility', price: 34700, emoji: '🩼',
    ...
    { id: 'rollator', name: '3-Wheel Folding Rollator Walker', category: 'mobility', price: 62400, emoji: '🚶',
    ...
    { id: 'wheelchair', name: 'Foldable Manual Wheelchair', category: 'mobility', price: 240900, emoji: '🦽',
    ...
    { id: 'first-aid-kit', name: 'Premium First Aid Kit (120-piece)', category: 'firstaid', price: 21300, emoji: '🧰',
    ...
    { id: 'face-masks', name: 'Disposable Face Masks (Pack of 50)', category: 'firstaid', price: 5300, emoji: '😷',
    ...
    { id: 'hand-sanitizer', name: 'Hand Sanitizer (Pack of 3)', category: 'firstaid', price: 2400, emoji: '🧴',
    ...
    { id: 'knee-brace', name: 'Elastic Knee Support Brace', category: 'support', price: 11300, emoji: '🦵',
    ...
    { id: 'wrist-splint', name: 'Adjustable Wrist Splint', category: 'support', price: 13300, emoji: '🖐️',
    ...
    { id: 'posture-brace', name: 'Posture Corrector Back Brace', category: 'support', price: 8800, emoji: '🧍',
    ...
    { id: 'compression-socks', name: 'Compression Socks (Pair)', category: 'support', price: 16400, emoji: '🧦',
    ...
    { id: 'ankle-support', name: 'Ankle Support Brace', category: 'support', price: 9400, emoji: '🦶',
    ...
    { id: 'multivitamin-60', name: 'Multivitamin & Mineral Tablets (60ct)', category: 'supplements', price: 8800, emoji: '🌿',
    ...
    { id: 'vitamin-c-20', name: 'Vitamin C Effervescent Tablets (20ct)', category: 'supplements', price: 6200, emoji: '🍊',
    ...
    { id: 'omega3-60', name: 'Omega-3 Fish Oil Capsules (60ct)', category: 'supplements', price: 12000, emoji: '🐟',
    ...
    { id: 'probiotic-30', name: 'Probiotic Capsules (30ct)', category: 'supplements', price: 11300, emoji: '🦠',
    ...
    { id: 'moringa-powder-250g', name: 'Moringa Leaf Powder (250g)', category: 'supplements', price: 6200, emoji: '🌿',
    ...
    { id: 'diabetic-foot-lotion', name: 'Diabetic-Friendly Foot & Skin Lotion', category: 'wellness', price: 7500, emoji: '🧴',
    ...
    { id: 'turmeric-ginger-powder', name: 'Turmeric & Ginger Superfood Powder (200g)', category: 'supplements', price: 5900, emoji: '🌕',
