...
(function () {
  ...
  const PRODUCTS = [
    ...
    // ---- Fitness & Wellness ----------------------------------------------
    { id: 'exercise-mat', name: 'Foam Exercise / Yoga Mat', category: 'wellness', price: 11500, emoji: '🧘',
    ...
    { id: 'resistance-bands', name: 'Resistance Exercise Bands (Set)', category: 'wellness', price: 8500, emoji: '🎗️',
    ...
    { id: 'foam-roller', name: 'Foam Roller', category: 'wellness', price: 11500, emoji: '🎢',
    ...
    { id: 'skipping-rope', name: 'Skipping / Jump Rope', category: 'wellness', price: 2900, emoji: '🪢',
    ...
    { id: 'gym-duffel-bag', name: 'Sports & Gym Duffel Bag', category: 'wellness', price: 11500, emoji: '🎒',
    ...
    { id: 'moisturizing-foot-lotion', name: 'Moisturizing Foot & Body Lotion', category: 'wellness', price: 5000, emoji: '🧴',
    ...
    { id: 'pure-honey-500ml', name: 'Pure Natural Honey (500ml)', category: 'nutrition', price: 8500, emoji: '🍯',
    ...
    { id: 'rolled-oats-1kg', name: 'Rolled Oats (1kg)', category: 'nutrition', price: 6400, emoji: '🥣',
    ...
    { id: 'fresh-ginger-500g', name: 'Fresh Ginger Root (500g)', category: 'nutrition', price: 1700, emoji: '🫚',
    ...
    { id: 'zobo-drink', name: 'Chilled Zobo (Hibiscus) Drink (1.5L)', category: 'nutrition', price: 2150, emoji: '🥤',
    ...
    { id: 'tiger-nuts-500g', name: 'Dried Tiger Nuts / Aya (500g)', category: 'nutrition', price: 3100, emoji: '🌰',
    ...
    { id: 'garlic-bulbs-250g', name: 'Fresh Garlic Bulbs (250g)', category: 'nutrition', price: 1400, emoji: '🧄',
    ...
    { id: 'cashew-nuts-500g', name: 'Roasted Cashew Nuts (500g)', category: 'nutrition', price: 6400, emoji: '🥜',
    ...
    { id: 'groundnuts-500g', name: 'Roasted Groundnuts (500g)', category: 'nutrition', price: 2150, emoji: '🥜',
    ...
    { id: 'mixed-fruit-smoothies-4pk', name: 'Mixed Fruit Smoothie Bottles (4-Pack)', category: 'nutrition', price: 6400, emoji: '🥤',
    ...
    { id: 'strawberry-smoothie', name: 'Strawberry Fruit Smoothie (500ml)', category: 'nutrition', price: 2600, emoji: '🍓',
    ...
    { id: 'chamomile-lavender-tea', name: 'Chamomile & Lavender Herbal Tea (20 bags)', category: 'nutrition', price: 4000, emoji: '🍵',
    ...
    { id: 'ginger-lemongrass-tea', name: 'Ginger & Lemongrass Herbal Tea (20 bags)', category: 'nutrition', price: 3400, emoji: '🌿',
    ...
    { id: 'turmeric-ginger-powder', name: 'Turmeric & Ginger Powder (200g)', category: 'nutrition', price: 4600, emoji: '🌕',
    ...
    { id: 'moringa-powder-250g', name: 'Moringa Leaf Powder (250g)', category: 'nutrition', price: 4900, emoji: '🌿',
    ...
    // ---- Fresh Fruits ---------------------------------------------------
    { id: 'fruit-basket-mixed', name: 'Mixed Fruit Basket (Seasonal)', category: 'fruits', price: 11500, emoji: '🧺',
    ...
    { id: 'apples-1kg', name: 'Fresh Apples (1kg)', category: 'fruits', price: 4000, emoji: '🍎',
    ...
    { id: 'oranges-1kg', name: 'Fresh Oranges (1kg)', category: 'fruits', price: 1300, emoji: '🍊',
    ...
    { id: 'bananas-bunch', name: 'Fresh Bananas (Bunch)', category: 'fruits', price: 2150, emoji: '🍌',
    ...
    { id: 'watermelon-whole', name: 'Fresh Watermelon (Whole)', category: 'fruits', price: 2900, emoji: '🍉',
    ...
    { id: 'pawpaw-whole', name: 'Fresh Pawpaw / Papaya (Whole)', category: 'fruits', price: 1700, emoji: '🥭',
    ...
    { id: 'fresh-coconut', name: 'Fresh Coconut (Whole)', category: 'fruits', price: 1000, emoji: '🥥',
    ...
    { id: 'fresh-pineapple', name: 'Fresh Pineapple (Whole)', category: 'fruits', price: 1700, emoji: '🍍',
    ...
    { id: 'fresh-avocado', name: 'Fresh Avocado (Pack of 3)', category: 'fruits', price: 2600, emoji: '🥑',
    ...
    // ---- Personal & Skin Care --------------------------------------------
    { id: 'neem-teatree-soap', name: 'Neem & Tea Tree Herbal Soap (Bar)', category: 'personalcare', price: 2150, emoji: '🧼',
    ...
    { id: 'rose-shea-soap', name: 'Rose & Shea Butter Soap (Bar)', category: 'personalcare', price: 2150, emoji: '🌹',
    ...
    { id: 'mens-shaving-cream', name: "Men's Herbal Shaving Cream (150g)", category: 'personalcare', price: 4000, emoji: '🪒',
    ...
    { id: 'herbal-hair-scalp-oil', name: 'Herbal Hair & Scalp Oil (200ml)', category: 'personalcare', price: 4300, emoji: '💆',
    ...
    { id: 'sleep-eye-mask', name: 'Sleep Eye Mask', category: 'personalcare', price: 2600, emoji: '😴',
    ...
    { id: 'microfiber-towel', name: 'Quick-Dry Microfiber Towel', category: 'personalcare', price: 3600, emoji: '🧻',
    ...
    { id: 'insulated-water-bottle', name: 'Insulated Stainless Steel Water Bottle', category: 'kitchen-living', price: 7900, emoji: '🥤',
    ...
    { id: 'sports-water-bottle', name: 'Everyday Sports Water Bottle', category: 'kitchen-living', price: 2600, emoji: '💧',
    ...
    { id: 'glass-storage-jars', name: 'Glass Food Storage Jars (Set)', category: 'kitchen-living', price: 6400, emoji: '🫙',
    ...
    { id: 'meal-prep-containers', name: 'Reusable Meal Prep Containers (Set)', category: 'kitchen-living', price: 5700, emoji: '🍱',
    ...
    { id: 'reusable-tote-bag', name: 'Reusable Canvas Tote Bag', category: 'kitchen-living', price: 2600, emoji: '🛍️',
    ...
    { id: 'green-tea-20bags', name: 'Green Tea (20 bags)', category: 'nutrition', price: 3100, emoji: '🍵',
    ...
    { id: 'chia-seeds-250g', name: 'Chia Seeds (250g)', category: 'nutrition', price: 4600, emoji: '🌱',
    ...
    { id: 'dried-dates-500g', name: 'Dried Dates (500g)', category: 'nutrition', price: 3700, emoji: '🌴',
    ...
    { id: 'fresh-mango', name: 'Fresh Mango (Pack of 2)', category: 'fruits', price: 2150, emoji: '🥭',
    ...
    { id: 'bamboo-toothbrush', name: 'Bamboo Toothbrush', category: 'personalcare', price: 1300, emoji: '🪥',
